...
class InstructorJuniorGradeScreen extends StatefulWidget {
  ...
  @override
  State<InstructorJuniorGradeScreen> createState() =>
      _InstructorJuniorGradeScreenState();
}

class _InstructorJuniorGradeScreenState
    extends State<InstructorJuniorGradeScreen> {
  @override
  void initState() {
    super.initState();
    getStudentSubject();
