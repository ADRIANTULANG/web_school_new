...
class InstructorSeniorGradeScreen extends StatefulWidget {
  ...
  @override
  State<InstructorSeniorGradeScreen> createState() =>
      _InstructorSeniorGradeScreenState();
}

class _InstructorSeniorGradeScreenState
    extends State<InstructorSeniorGradeScreen> {
  @override
  void initState() {
    super.initState();
    getStudentSubject();
