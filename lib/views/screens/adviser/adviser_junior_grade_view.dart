...
@RoutePage()
class AdviserJuniorGradeView extends StatefulWidget {
  const AdviserJuniorGradeView(
  ...
  @override
  State<AdviserJuniorGradeView> createState() => _AdviserJuniorGradeViewState();
}

class _AdviserJuniorGradeViewState extends State<AdviserJuniorGradeView> {
  @override
  void initState() {
    super.initState();
    getStudentSubject();
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            "${widget.studentData.studentInfo.name}'s grade JUNIOR",
  ...
  //               pw.Center(child: pw.Text("First Grading")),
  //               pw.Center(child: pw.Text("Second Grading")),
  //               pw.Center(child: pw.Text("Third Grading")),
  //               pw.Center(child: pw.Text("Fourth Grading")),
  //             ]),
  //             // // Data rows
  //             pw.TableRow(children: [
