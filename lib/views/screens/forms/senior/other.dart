...
@RoutePage()
class OtherSchoolScreen extends StatelessWidget {
  static String route = "otherSchool";
  const OtherSchoolScreen({super.key});
                ...
                child: Center(
                  child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "For New Senior High School From Other School Student Enrollment Form",
